...
{
    public class ListSourceTypeConfiguration : IEntityTypeConfiguration<List_source_type>
    {
        public void Configure(EntityTypeBuilder<List_source_type> entity)
        {
            entity.ToTable("list_source_type", "ref");
