...
{
    public class ListSampleStandardConfiguration : IEntityTypeConfiguration<List_sample_standard>
    {
        public void Configure(EntityTypeBuilder<List_sample_standard> entity)
        {
            entity.ToTable("list_sample_standard", "ref");
