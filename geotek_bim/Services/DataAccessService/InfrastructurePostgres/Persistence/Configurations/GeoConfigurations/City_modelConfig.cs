...
{
    public class CityModelConfiguration : IEntityTypeConfiguration<City_model>
    {
        public void Configure(EntityTypeBuilder<City_model> entity)
        {
            entity.ToTable("city_model", "geo");
