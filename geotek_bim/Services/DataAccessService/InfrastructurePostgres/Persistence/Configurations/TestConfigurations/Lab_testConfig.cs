...
{
    public class LabTestConfiguration : IEntityTypeConfiguration<Lab_test>
    {
        public void Configure(EntityTypeBuilder<Lab_test> entity)
        {
            entity.ToTable("lab_test", "test");
